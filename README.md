<img align="center" width="750" src="https://github.com/OlgaSelivanova1/Service-Taxi/blob/main/img/8724.jpg">
<h4>Материалы предназначены исключительно для презентации навыков  в области PL/SQL разработки  и построения аналитических запросов SQL в СУБД Oracle <h4>
...
<ul>
  <li>Водитель</li>
    <ul>
      <li>Регистрируется в системе</li>
      <li>Авторизируется в системе</li>
